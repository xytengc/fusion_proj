classdef Reshape_To_ConcatLayer1016 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods
        function this = Reshape_To_ConcatLayer1016(name, onnxParams)
            this.Name = name;
            this.NumInputs = 3;
            this.OutputNames = {'output0'};
            this.ONNXParams = onnxParams;
            this.onnx__Split_349 = onnxParams.Learnables.onnx__Split_349;
        end
        ...
        function [output0] = predict(this, x_model_24_m_0_Conv_, x_model_24_m_1_Conv_, x_model_24_m_2_Conv_)
            ...
            onnxParams.Learnables.onnx__Split_349 = this.onnx__Split_349;
            ...
            if any(cellfun(@(A)~isnumeric(A), {output0}))
                fprintf('Runtime error in network. The custom layer ''%s'' output a non-numeric value.\n', 'Reshape_To_ConcatLayer1016');
                error(message('nnet_cnn_onnx:onnx:BadCustomLayerRuntimeOutput', 'Reshape_To_ConcatLayer1016'));
            end
...
[output0, output0NumDims, state] = Reshape_To_ConcatGraph1008(x_model_24_m_0_Conv_, x_model_24_m_1_Conv_, x_model_24_m_2_Conv_, NumDims.x_model_24_m_0_Conv_, NumDims.x_model_24_m_1_Conv_, NumDims.x_model_24_m_2_Conv_, Vars, NumDims, Training, params.State);
% Postprocess the output data
[output0] = postprocessOutput(output0, outputDataPerms, anyDlarrayInputs, Training, varargin{:});
end

function [output0, output0NumDims1015, state] = Reshape_To_ConcatGraph1008(x_model_24_m_0_Conv_, x_model_24_m_1_Conv_, x_model_24_m_2_Conv_, x_model_24_m_0_Conv_NumDims1012, x_model_24_m_1_Conv_NumDims1013, x_model_24_m_2_Conv_NumDims1014, Vars, NumDims, Training, state)
% Function implementing the graph 'Reshape_To_ConcatGraph1008'
% Update Vars and NumDims from the graph's formal input parameters. Note that state variables are already in Vars.
Vars.x_model_24_m_0_Conv_ = x_model_24_m_0_Conv_;
NumDims.x_model_24_m_0_Conv_ = x_model_24_m_0_Conv_NumDims1012;
Vars.x_model_24_m_1_Conv_ = x_model_24_m_1_Conv_;
NumDims.x_model_24_m_1_Conv_ = x_model_24_m_1_Conv_NumDims1013;
Vars.x_model_24_m_2_Conv_ = x_model_24_m_2_Conv_;
NumDims.x_model_24_m_2_Conv_ = x_model_24_m_2_Conv_NumDims1014;

% Execute the operators:
% Reshape:
[shape, NumDims.x_model_24_Reshape_o] = prepareReshapeArgs(Vars.x_model_24_m_0_Conv_, Vars.x_model_24_Consta_15, NumDims.x_model_24_m_0_Conv_, 0);
Vars.x_model_24_Reshape_o = reshape(Vars.x_model_24_m_0_Conv_, shape{:});

% Transpose:
[perm, NumDims.x_model_24_Transpo_2] = prepareTransposeArgs(Vars.TransposePerm1009, NumDims.x_model_24_Reshape_o);
if ~isempty(perm)
...
% Split:
[Vars.x_model_24_Split_out, Vars.x_model_24_Split_o_1, Vars.x_model_24_Split_o_2, NumDims.x_model_24_Split_out, NumDims.x_model_24_Split_o_1, NumDims.x_model_24_Split_o_2] = onnxSplit13(Vars.x_model_24_Sigmoid_o, 4, Vars.onnx__Split_349, 3, NumDims.x_model_24_Sigmoid_o);

% Mul:
Vars.x_model_24_Mul_outpu = Vars.x_model_24_Split_out .* Vars.x_model_24_Consta_7;
NumDims.x_model_24_Mul_outpu = max(NumDims.x_model_24_Split_out, NumDims.x_model_24_Consta_7);

% Add:
Vars.x_model_24_Add_outpu = Vars.x_model_24_Mul_outpu + Vars.x_model_24_Consta_10;
NumDims.x_model_24_Add_outpu = max(NumDims.x_model_24_Mul_outpu, NumDims.x_model_24_Consta_10);

% Mul:
Vars.x_model_24_Mul_1_out = Vars.x_model_24_Add_outpu .* Vars.x_model_24_Consta_11;
NumDims.x_model_24_Mul_1_out = max(NumDims.x_model_24_Add_outpu, NumDims.x_model_24_Consta_11);

% Mul:
Vars.x_model_24_Mul_2_out = Vars.x_model_24_Split_o_1 .* Vars.x_model_24_Consta_7;
NumDims.x_model_24_Mul_2_out = max(NumDims.x_model_24_Split_o_1, NumDims.x_model_24_Consta_7);

% Pow:
Vars.x_model_24_Pow_outpu = power(Vars.x_model_24_Mul_2_out, Vars.x_model_24_Consta_7);
NumDims.x_model_24_Pow_outpu = max(NumDims.x_model_24_Mul_2_out, NumDims.x_model_24_Consta_7);

% Mul:
Vars.x_model_24_Mul_3_out = Vars.x_model_24_Pow_outpu .* Vars.x_model_24_Consta_12;
NumDims.x_model_24_Mul_3_out = max(NumDims.x_model_24_Pow_outpu, NumDims.x_model_24_Consta_12);
...
% Reshape:
[shape, NumDims.x_model_24_Reshape_1] = prepareReshapeArgs(Vars.x_model_24_Concat_ou, Vars.x_model_24_Consta_13, NumDims.x_model_24_Concat_ou, 0);
Vars.x_model_24_Reshape_1 = reshape(Vars.x_model_24_Concat_ou, shape{:});

% Reshape:
[shape, NumDims.x_model_24_Reshape_2] = prepareReshapeArgs(Vars.x_model_24_m_1_Conv_, Vars.x_model_24_Consta_14, NumDims.x_model_24_m_1_Conv_, 0);
Vars.x_model_24_Reshape_2 = reshape(Vars.x_model_24_m_1_Conv_, shape{:});

% Transpose:
[perm, NumDims.x_model_24_Transpose] = prepareTransposeArgs(Vars.TransposePerm1010, NumDims.x_model_24_Reshape_2);
if ~isempty(perm)
...
% Split:
[Vars.x_model_24_Split_1_o, Vars.x_model_24_Split_1_1, Vars.x_model_24_Split_1_2, NumDims.x_model_24_Split_1_o, NumDims.x_model_24_Split_1_1, NumDims.x_model_24_Split_1_2] = onnxSplit13(Vars.x_model_24_Sigmoid_1, 4, Vars.onnx__Split_349, 3, NumDims.x_model_24_Sigmoid_1);

% Mul:
Vars.x_model_24_Mul_4_out = Vars.x_model_24_Split_1_o .* Vars.x_model_24_Consta_7;
NumDims.x_model_24_Mul_4_out = max(NumDims.x_model_24_Split_1_o, NumDims.x_model_24_Consta_7);
...
% Mul:
Vars.x_model_24_Mul_6_out = Vars.x_model_24_Split_1_1 .* Vars.x_model_24_Consta_7;
NumDims.x_model_24_Mul_6_out = max(NumDims.x_model_24_Split_1_1, NumDims.x_model_24_Consta_7);

% Pow:
Vars.x_model_24_Pow_1_out = power(Vars.x_model_24_Mul_6_out, Vars.x_model_24_Consta_7);
NumDims.x_model_24_Pow_1_out = max(NumDims.x_model_24_Mul_6_out, NumDims.x_model_24_Consta_7);

% Mul:
Vars.x_model_24_Mul_7_out = Vars.x_model_24_Pow_1_out .* Vars.x_model_24_Consta_2;
NumDims.x_model_24_Mul_7_out = max(NumDims.x_model_24_Pow_1_out, NumDims.x_model_24_Consta_2);
...
% Reshape:
[shape, NumDims.x_model_24_Reshape_3] = prepareReshapeArgs(Vars.x_model_24_Concat_1_, Vars.x_model_24_Consta_3, NumDims.x_model_24_Concat_1_, 0);
Vars.x_model_24_Reshape_3 = reshape(Vars.x_model_24_Concat_1_, shape{:});

% Reshape:
[shape, NumDims.x_model_24_Reshape_4] = prepareReshapeArgs(Vars.x_model_24_m_2_Conv_, Vars.x_model_24_Consta_4, NumDims.x_model_24_m_2_Conv_, 0);
Vars.x_model_24_Reshape_4 = reshape(Vars.x_model_24_m_2_Conv_, shape{:});

% Transpose:
[perm, NumDims.x_model_24_Transpo_1] = prepareTransposeArgs(Vars.TransposePerm1011, NumDims.x_model_24_Reshape_4);
if ~isempty(perm)
...
% Split:
[Vars.x_model_24_Split_2_o, Vars.x_model_24_Split_2_1, Vars.x_model_24_Split_2_2, NumDims.x_model_24_Split_2_o, NumDims.x_model_24_Split_2_1, NumDims.x_model_24_Split_2_2] = onnxSplit13(Vars.x_model_24_Sigmoid_2, 4, Vars.onnx__Split_349, 3, NumDims.x_model_24_Sigmoid_2);
...
% Add:
Vars.x_model_24_Add_2_out = Vars.x_model_24_Mul_8_out + Vars.x_model_24_Consta_5;
NumDims.x_model_24_Add_2_out = max(NumDims.x_model_24_Mul_8_out, NumDims.x_model_24_Consta_5);

% Mul:
Vars.x_model_24_Mul_9_out = Vars.x_model_24_Add_2_out .* Vars.x_model_24_Consta_6;
NumDims.x_model_24_Mul_9_out = max(NumDims.x_model_24_Add_2_out, NumDims.x_model_24_Consta_6);

% Mul:
Vars.x_model_24_Mul_10_ou = Vars.x_model_24_Split_2_1 .* Vars.x_model_24_Consta_7;
NumDims.x_model_24_Mul_10_ou = max(NumDims.x_model_24_Split_2_1, NumDims.x_model_24_Consta_7);

% Pow:
Vars.x_model_24_Pow_2_out = power(Vars.x_model_24_Mul_10_ou, Vars.x_model_24_Consta_7);
NumDims.x_model_24_Pow_2_out = max(NumDims.x_model_24_Mul_10_ou, NumDims.x_model_24_Consta_7);

% Mul:
Vars.x_model_24_Mul_11_ou = Vars.x_model_24_Pow_2_out .* Vars.x_model_24_Consta_8;
NumDims.x_model_24_Mul_11_ou = max(NumDims.x_model_24_Pow_2_out, NumDims.x_model_24_Consta_8);
...
% Reshape:
[shape, NumDims.x_model_24_Reshape_5] = prepareReshapeArgs(Vars.x_model_24_Concat_2_, Vars.x_model_24_Consta_9, NumDims.x_model_24_Concat_2_, 0);
...
output0NumDims1015 = NumDims.output0;
